...
#1B9E77aqua, #CC3300 the red, the light blue #56B4E9
# plot
bar_species = ggplot(ps_rel_genus_melt, aes(x = forcats::fct_reorder(X2020_Mote_ID, out.num), y=Abundance)) + 
  ...
  scale_fill_manual(values=c("#009E75","#0072B2", "#5","#E69F00","#660066", "#D55E00", "#FFFF00", "#CC79A7","dark grey","light grey"), 
...
bar_species
ggsave(filename="Figure2b.png", plot=bar_species,width=35, height=20 , units="cm",device="png", dpi=300)
